...
namespace Capstone.Classes.Test
{
    ...
    public class UnitTest1
    {
        ...
        public void InventoryTest()
        {
            ...
            Catering test = new Catering();
            //Act
            string[] result = test.Inventory();
            string expect = "B4 Sparkling Water $2.35 B 50";
            //Assert
            Assert.AreEqual(expect, result[3]);
        }
        [TestMethod]
        public void PrintReportTest()
        {
            //Arrage
            Catering test = new Catering();
            CateringItem testItem = test.itemsDictionary["B4"];
            test.ShoppingCart[testItem] = 2;
            //Act
            string[] result = test.PrintReport();
            string expect = "2 Beverage Sparkling Water $2.35 $4.7";
            //Assert
